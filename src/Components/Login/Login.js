...
import facebookIcon from '../../images/icons/facebook2.png';
...
const Login = () => {
	...
	const onSubmit = (data) => {
		...
		if (newUser && LastName && rePassword) {
			createUserWithEmailAndPassword(email, password, name).then(
				(response) => {
					handleResponse(response, true);
				}
			);
						...
						<div className='login-form'>
							...
							<div className='provider-login'>
								...
								<button
									...
									className='api-login'
								>
									<img src={facebookIcon} alt='' /> Continue
									with Facebook
								</button>
								<button
